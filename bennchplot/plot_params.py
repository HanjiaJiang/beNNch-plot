...
label_params = {
    ...
    'wall_time_phase_update': 'Spike Update',
    'wall_time_phase_collocate': 'Spike Collocation',
    'wall_time_phase_communicate': 'Spike Communication',
    'wall_time_phase_deliver': 'Spike Delivery',
    'wall_time_create+wall_time_connect': 'Network construction',
    'max_memory': 'Memory',
    'sim_factor': 'State propagation',
    'frac_phase_update': 'Update',
    'frac_phase_communicate': 'Spike Communication',
    'frac_phase_deliver': 'Spike Delivery',
    'frac_phase_collocate': 'Spike Collocation',
    'frac_phase_secondary': 'Secondary GD',
    'frac_phase_deliver_secondary': 'Spike Delivery',
    'frac_phase_gather_secondary': 'Secondary Gathering',
    'phase_update_factor': 'Update',
    'phase_communicate_factor': 'Spike Communication',
    'phase_deliver_factor': 'Spike Delivery',
    'phase_collocate_factor': 'Spike Collocation',
    'phase_secondary_factor': 'Secondary GD',
    'phase_deliver_secondary_factor': 'Secondary Delivery',
    'phase_gather_secondary_factor': 'Secondary Gathering',
    'phase_total_factor': 'All phases',
    'total_memory': 'Memory',
    'total_memory_per_node': 'Memory per node',
    'total_spike_count_per_s': 'Total spikes/s',
    'phase_ccd_factor': 'Spike CCD',
