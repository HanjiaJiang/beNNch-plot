...
color_params = {
    ...
    'phase_signal_transmission_factor': light.light_yellow,
    'frac_phase_signal_transmission': light.light_yellow,
...
#    'local_spike_counter': 'Spike count',
    ...
    'phase_signal_transmission_factor': 'Communications',
    'frac_phase_signal_transmission': 'Communications',
