...
label_params = {
    ...
    'wall_time_phase_update': 'spk-Update',
    'wall_time_phase_collocate': 'spk-Collocation',
    'wall_time_phase_communicate': 'spk-Communication',
    'wall_time_phase_deliver': 'spk-Delivery',
    'wall_time_create+wall_time_connect': 'Network construction',
    'max_memory': 'Memory',
    'sim_factor': 'State propagation',
    'frac_phase_update': 'Update',
    'frac_phase_communicate': 'spk-Communication',
    'frac_phase_deliver': 'spk-Delivery',
    'frac_phase_collocate': 'spk-Collocation',
    'frac_phase_secondary': 'Secondary',
    'frac_phase_deliver_secondary': 'spk-Delivery',
    'frac_phase_gather_secondary': 'sec-Gather',
    'phase_update_factor': 'Update',
    'phase_communicate_factor': 'spk-Communication',
    'phase_deliver_factor': 'spk-Delivery',
    'phase_collocate_factor': 'spk-Collocation',
    'phase_secondary_factor': 'Secondary',
    'phase_deliver_secondary_factor': 'sec-Delivery',
    'phase_gather_secondary_factor': 'sec-Gather',
